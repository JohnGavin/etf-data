...
# Point to the targets store
# In CI, pkgdown builds in a temp dir, so we need an absolute path to the store in the workspace
store_path <- Sys.getenv("TARGETS_STORE")
if (store_path == "") store_path <- "../_targets"
